...
class SelectCarrierControllerTest extends TestCase
{
    public function testHandleSelectCarrierReturnsTechnicalErrorWhenModuleIsDisabled(): void
    {
        $controller = new class extends \Ps_OnepagecheckoutSelectCarrierModuleFrontController {
