...
namespace PrestaShop\Module\PsOnePageCheckout\Vendor\Segment\Consumer;
...
abstract class QueueConsumer extends Consumer
{
    ...
    protected int $max_queue_size_bytes = 33554432;
    //32M
    protected int $flush_at = 100;
    protected int $max_batch_size_bytes = 512000;
    //500kb
    protected int $max_item_size_bytes = 32000;
    // 32kb
    protected int $maximum_backoff_duration = 10000;
    // Set maximum waiting limit to 10s
    protected string $host = '';
    protected bool $compress_request = \false;
    protected int $flush_interval_in_mills = 10000;
    //frequency in milliseconds to send data, default 10
    protected int $curl_timeout = 0;
    ...
    {
        return ['batch' => $batch, 'sentAt' => date('c')];
    }
}
