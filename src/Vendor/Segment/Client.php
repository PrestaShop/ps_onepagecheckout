...
namespace PrestaShop\Module\PsOnePageCheckout\Vendor\Segment;

use PrestaShop\Module\PsOnePageCheckout\Vendor\Segment\Consumer\Consumer;
use PrestaShop\Module\PsOnePageCheckout\Vendor\Segment\Consumer\File;
use PrestaShop\Module\PsOnePageCheckout\Vendor\Segment\Consumer\ForkCurl;
use PrestaShop\Module\PsOnePageCheckout\Vendor\Segment\Consumer\LibCurl;
use PrestaShop\Module\PsOnePageCheckout\Vendor\Segment\Consumer\Socket;
class Client
{
    ...
    {
        $consumers = ['socket' => Socket::class, 'file' => File::class, 'fork_curl' => ForkCurl::class, 'lib_curl' => LibCurl::class];
    ...
    private function getDefaultContext(): array
    {
        ...
        return ['library' => ['name' => 'analytics-php', 'version' => $SEGMENT_VERSION, 'consumer' => $this->consumer->getConsumer()]];
    }
    /**
