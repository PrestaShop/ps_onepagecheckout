    ...
    <div class="modal-content address-form-container">
      ...
      <div class="modal-body">
        <div class="row">
          ...
          {if isset($formFields[$_key_alias])}{form_field field=$formFields[$_key_alias] file='module:ps_onepagecheckout/views/templates/front/_partials/form-fields.tpl'}{/if}
          ...
          {if isset($formFields[$_key_company])}{form_field field=$formFields[$_key_company] file='module:ps_onepagecheckout/views/templates/front/_partials/form-fields.tpl'}{/if}

          {if isset($formFields[$_key_vat_number])}{form_field field=$formFields[$_key_vat_number] file='module:ps_onepagecheckout/views/templates/front/_partials/form-fields.tpl'}{/if}

          {if isset($formFields[$_key_address1])}{form_field field=$formFields[$_key_address1] file='module:ps_onepagecheckout/views/templates/front/_partials/form-fields.tpl'}{/if}

          {if isset($formFields[$_key_address2])}{form_field field=$formFields[$_key_address2] file='module:ps_onepagecheckout/views/templates/front/_partials/form-fields.tpl'}{/if}

          <div class="form-fields-row form-fields-row--2 address-country-row">
            {if isset($formFields[$_key_city])}{form_field field=$formFields[$_key_city] file='module:ps_onepagecheckout/views/templates/front/_partials/form-fields.tpl'}{/if}
            ...
            {if isset($formFields[$_key_postcode])}{form_field field=$formFields[$_key_postcode] file='module:ps_onepagecheckout/views/templates/front/_partials/form-fields.tpl'}{/if}
          </div>

          {if isset($formFields[$_key_phone])}{form_field field=$formFields[$_key_phone] file='module:ps_onepagecheckout/views/templates/front/_partials/form-fields.tpl'}{/if}
        </div>
      </div>
