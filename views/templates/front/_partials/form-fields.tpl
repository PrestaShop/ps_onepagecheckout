...
{else}
  ...
  <div class="mb-3{if !empty($field.errors)} has-error{/if}">
    ...
    {elseif $field.type === 'date'}
      ...
      {block name='form_field_item_date'}
        <input
          ...
          id="field-{$field.name}"
          value="{$field.value}"
          {if isset($field.availableValues.placeholder)} placeholder="{$field.availableValues.placeholder}" aria-label="{$field.availableValues.placeholder}"{/if}
        >
    ...
    {block name='form_field_errors'}
      {include file='module:ps_onepagecheckout/views/templates/front/_partials/form-errors.tpl' errors=$field.errors}
    {/block}
